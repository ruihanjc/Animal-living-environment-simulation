...
public class Simulator{
    ...
    private static final double SHEEP_CREATION_PROBABILITY = 0.07;
    // The probability that a rabbit will be created in any given grid position.
    ...
    private boolean showRabbits = true, showFoxes = true, showWolves = true, showSheep = true, showSnakes = true, hasGrass = true;
        ...
        for(int row = 0; row < field.getDepth(); row++){
            for(int col = 0; col < field.getWidth(); col++){
                if(showFoxes && rand.nextDouble() <= FOX_CREATION_PROBABILITY){
                    ...
                    actors.add(wolf);
                } else if(hasGrass && rand.nextDouble() <= 0.2){
                    Location location = new Location(row, col);
    ...
    private void setHasGrass(boolean hasGrass){
    ...
    private void setMenuBar(){
        ...
        JCheckBoxMenuItem grassItem = new JCheckBoxMenuItem("Show Grass");
    ...
    private void setButtonBar(){
        ...
        JButton runButton = new JButton("Fifty");
        runButton.addActionListener(e -> simulate(50));
        runButton.addActionListener(e -> updateStatsDisplay());

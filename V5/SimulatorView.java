...
public class SimulatorView extends JFrame{
    ...
    public void showStatus(int step,int time, String day ,Field field, String currentWeather){
        ...
        population.setText("        " + POPULATION_PREFIX + stats.getPopulationDetails(field)+
                "                 " + STEP_PREFIX + step + "  " + TIME_PREFIX + time + " o'clock" + "  " + day +"    "+WEATHER_PREFIX + "  " + 
                currentWeather );
        stats.reset();
        ...
        for(int row = 0; row < field.getDepth(); row++){
            for(int col = 0; col < field.getWidth(); col++){
                ...
                if(object instanceof Object[]) {
                    Object[] actors = (Object[]) object;
                    if (actors[1] != null) {
                        stats.incrementCount(actors[1].getClass());
                        fieldView.drawMark(col, row, getColor(actors[1].getClass()));
                    } else if (actors[0] != null){
                        stats.incrementCount(actors[0].getClass());
                        fieldView.drawMark(col, row, getColor(actors[0].getClass()));
                    } else {

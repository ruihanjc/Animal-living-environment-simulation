...
public class FoodChain
{
    ...
    public FoodChain()
    {
        huntingRelation.put(Fox.class, new Class[]{Rabbit.class});
        huntingRelation.put(Snake.class, new Class[]{Rabbit.class});
        huntingRelation.put(Rabbit.class, new Class[]{Grass.class});             

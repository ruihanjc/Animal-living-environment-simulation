 ...
 * containing Cow, Liones, sheep, wolfs and snakes
...
public class Simulator{
    ...
    private boolean showCows = true, showLions = true, showWolves = true, showSheep = true, showSnakes = true, showGrass = true;
    //The current weather
    ...
    public void simulateOneStep(){
        ...
        if(field.getAllFreeLocations(1).size() > 0.8 * field.getWidth() * field.getDepth()){
            populate();
        }
        updateStatsDisplay();
    }
    ...
    /**
     * Randomly populate the field with Liones, Cow, snakes, wolves, and grass.
     */

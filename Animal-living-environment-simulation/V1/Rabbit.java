...
public class Rabbit extends Animal
{
    ...
    {
        return (age >= BREEDING_AGE && possibleToBreed(Rabbit.class));
    }

    // private boolean possibleToBreed(){
        // for(Location location : getField().adjacentLocations(getLocation())){
           // Object locationObject = getField().getObjectAt(location);
           // if(locationObject != null && locationObject instanceof Rabbit){
               // Rabbit a = (Rabbit)locationObject;
